...
angular.module('app.services', ['LocalStorageModule'])
    ...
    .factory('quickSettingsTexts', function () {
        var currentChannel = webapis.tv.channel.getCurrentChannel(),
        	channelName = currentChannel.channelName,
            channelNumber = currentChannel.programNumber,
            factory = {
                getTexts: function() {
                    return {
                        'recording_enabled': 'Stop recording ' + channelName + ' ' + channelNumber + ' now',
                        'recording_disabled':'Start recording ' + channelName + ' ' + channelNumber + ' now',
                        'favoriteChannel_enabled': 'Remove ' + channelName + ' ' + channelNumber + ' from Favorites List',
                        'favoriteChannel_disabled':'Add ' + channelName + ' ' + channelNumber + ' to Favorites List',
